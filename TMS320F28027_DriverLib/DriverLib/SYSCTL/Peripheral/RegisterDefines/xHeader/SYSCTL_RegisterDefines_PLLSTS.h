...
#define SYSCTL_PLLSTS_OSCOFF_ENA ((uint16_t) 0x0000U)
#define SYSCTL_PLLSTS_OSCOFF_DIS ((uint16_t) 0x0001U)

#define SYSCTL_PLLSTS_R_OSCOFF_MASK (SYSCTL_PLLSTS_OSCOFF_MASK<< SYSCTL_PLLSTS_R_OSCOFF_BIT)
#define SYSCTL_PLLSTS_R_OSCOFF_ENA (SYSCTL_PLLSTS_OSCOFF_ENA << SYSCTL_PLLSTS_R_OSCOFF_BIT)
#define SYSCTL_PLLSTS_R_OSCOFF_DIS (SYSCTL_PLLSTS_OSCOFF_DIS << SYSCTL_PLLSTS_R_OSCOFF_BIT)
/*-----------*/
...
#define SYSCTL_PLLSTS_MCLKOFF_ENA ((uint16_t) 0x0000U)
#define SYSCTL_PLLSTS_MCLKOFF_DIS ((uint16_t) 0x0001U)

#define SYSCTL_PLLSTS_R_MCLKOFF_MASK (SYSCTL_PLLSTS_MCLKOFF_MASK<< SYSCTL_PLLSTS_R_MCLKOFF_BIT)
#define SYSCTL_PLLSTS_R_MCLKOFF_ENA (SYSCTL_PLLSTS_MCLKOFF_ENA << SYSCTL_PLLSTS_R_MCLKOFF_BIT)
#define SYSCTL_PLLSTS_R_MCLKOFF_DIS (SYSCTL_PLLSTS_MCLKOFF_DIS << SYSCTL_PLLSTS_R_MCLKOFF_BIT)
/*-----------*/
