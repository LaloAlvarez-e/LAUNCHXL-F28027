...
typedef enum
{
    SYSCTL_enPLL_MULTIPLIER_BYPASS = 0U,
    SYSCTL_enPLL_MULTIPLIER_1 = 1U,
    SYSCTL_enPLL_MULTIPLIER_2 = 2U,
    SYSCTL_enPLL_MULTIPLIER_3 = 3U,
    SYSCTL_enPLL_MULTIPLIER_4 = 4U,
    SYSCTL_enPLL_MULTIPLIER_5 = 5U,
    SYSCTL_enPLL_MULTIPLIER_6 = 6U,
    SYSCTL_enPLL_MULTIPLIER_7 = 7U,
    SYSCTL_enPLL_MULTIPLIER_8 = 8U,
    SYSCTL_enPLL_MULTIPLIER_9 = 9U,
    SYSCTL_enPLL_MULTIPLIER_10 = 10U,
    SYSCTL_enPLL_MULTIPLIER_11 = 11U,
    SYSCTL_enPLL_MULTIPLIER_12 = 12U,
}SYSCTL_nPLL_MULTIPLIER;
