...
PAGE 0 :
   ...
   BEGIN    (RWX)  : origin = 0x000000, length = 0x000002
   RAMM0    (RWX)  : origin = 0x000050, length = 0x0003B0
   PRAML0   (RWX)  : origin = 0x008000, length = 0x000900
   RESET    (RX)   : origin = 0x3FFFC0, length = 0x000002

   IQTABLES  (RX) : origin = 0x3FE000, length = 0x000B50     /* IQ Math Tables in Boot ROM */
   IQTABLES2 (RX) : origin = 0x3FEB50, length = 0x00008C     /* IQ Math Tables in Boot ROM */
   IQTABLES3 (RX) : origin = 0x3FEBDC, length = 0x0000AA	 /* IQ Math Tables in Boot ROM */

   BOOTROM  (RX)  : origin = 0x3FF27C, length = 0x000D44


PAGE 1 :

   /* For this example, L0 is split between PAGE 0 and PAGE 1 */
   BOOT_RSVD (R)  : origin = 0x000002, length = 0x00004E     /* Part of M0, BOOT rom will use this for stack */
   RAMM1  (RW)    : origin = 0x000400, length = 0x000400     /* on-chip RAM block M1 */
   DRAML0 (RW)    : origin = 0x008900, length = 0x000700
}
