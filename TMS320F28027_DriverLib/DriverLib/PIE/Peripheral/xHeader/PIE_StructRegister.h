...
#ifndef DRIVERLIB_PIE_PERIPHERAL_XHEADER_PIE_STRUCTREGISTER_H_
#define DRIVERLIB_PIE_PERIPHERAL_XHEADER_PIE_STRUCTREGISTER_H_
...
#endif /* DRIVERLIB_PIE_PERIPHERAL_XHEADER_PIE_STRUCTREGISTER_H_ */
