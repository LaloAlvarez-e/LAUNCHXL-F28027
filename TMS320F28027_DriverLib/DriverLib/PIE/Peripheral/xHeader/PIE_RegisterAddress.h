...
#define PIE_GROUP1_BASE (PIE_BASE + PIE_GROUP1_OFFSET)
#define PIE_GROUP2_BASE (PIE_BASE + PIE_GROUP2_OFFSET)
#define PIE_GROUP3_BASE (PIE_BASE + PIE_GROUP3_OFFSET)
#define PIE_GROUP4_BASE (PIE_BASE + PIE_GROUP4_OFFSET)
#define PIE_GROUP5_BASE (PIE_BASE + PIE_GROUP5_OFFSET)
#define PIE_GROUP6_BASE (PIE_BASE + PIE_GROUP6_OFFSET)
#define PIE_GROUP7_BASE (PIE_BASE + PIE_GROUP7_OFFSET)
#define PIE_GROUP8_BASE (PIE_BASE + PIE_GROUP8_OFFSET)
#define PIE_GROUP9_BASE (PIE_BASE + PIE_GROUP9_OFFSET)
#define PIE_GROUP10_BASE (PIE_BASE + PIE_GROUP10_OFFSET)
#define PIE_GROUP11_BASE (PIE_BASE + PIE_GROUP11_OFFSET)
#define PIE_GROUP12_BASE (PIE_BASE + PIE_GROUP12_OFFSET)
