/**
 *
 * @file GPIO_InterruptRoutine_Vector_Module2.c
 * @copyright
...
interrupt void XINT2__vIRQVectorHandler(void)
{
    ...
    u16Pin = GPIOA_INTERRUPT_XINT2SEL_R;
    u32PinValue = GPIOA_DATA_DAT_R;
    u32PinValue >>= u16Pin;
    u32PinValue &= 1U;
    pvfCallback = GPIO__pvfGetIRQSourceHandler(GPIO_enXINT_2);
    pvfCallback(GPIO_enXINT_2, u32PinValue);
