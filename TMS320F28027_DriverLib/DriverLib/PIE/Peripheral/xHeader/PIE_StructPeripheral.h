...
typedef volatile struct
{
    ...
    MCU_IRQ_t EMU_IRQ;
    MCU_IRQ_t NMI_IRQ;
    MCU_IRQ_t ILLEGAL_IRQ;
    MCU_IRQ_t USER_IRQ[12U];
    MCU_IRQ_t GROUP1_IRQ[8U];
    MCU_IRQ_t GROUP2_IRQ[8U];
    MCU_IRQ_t GROUP3_IRQ[8U];
    MCU_IRQ_t GROUP4_IRQ[8U];
    MCU_IRQ_t GROUP5_IRQ[8U];
    MCU_IRQ_t GROUP6_IRQ[8U];
    MCU_IRQ_t GROUP7_IRQ[8U];
    MCU_IRQ_t GROUP8_IRQ[8U];
    MCU_IRQ_t GROUP9_IRQ[8U];
    MCU_IRQ_t GROUP10_IRQ[8U];
    MCU_IRQ_t GROUP11_IRQ[8U];
    MCU_IRQ_t GROUP12_IRQ[8U];
}PIE_IRQ_t;

typedef volatile struct
{
    MCU_IRQ_t ARRAY[128U];
}PIE_IRQ_ARRAY_t;
...
typedef volatile struct
{
    ...
    MCU_IRQ_t ILLEGAL_IRQ;
    MCU_IRQ_t USER_IRQ[12U];
    MCU_IRQ_t ADC1_PRI_IRQ;
    MCU_IRQ_t ADC2_PRI_IRQ;
    MCU_IRQ_t reserved2;
    MCU_IRQ_t X1_IRQ;
    MCU_IRQ_t X2_IRQ;
    MCU_IRQ_t ADC9_IRQ;
    MCU_IRQ_t T0_IRQ;
    MCU_IRQ_t WAKE_IRQ;
    MCU_IRQ_t EPWM1_TZ_IRQ;
    MCU_IRQ_t EPWM2_TZ_IRQ;
    MCU_IRQ_t EPWM3_TZ_IRQ;
    MCU_IRQ_t EPWM4_TZ_IRQ;
    MCU_IRQ_t reserved3[4U];
    MCU_IRQ_t EPWM1_IRQ;
    MCU_IRQ_t EPWM2_IRQ;
    MCU_IRQ_t EPWM3_IRQ;
    MCU_IRQ_t EPWM4_IRQ;
    MCU_IRQ_t reserved4[4U];
    MCU_IRQ_t ECAP1_IRQ;
    MCU_IRQ_t reserved5[7U];
    MCU_IRQ_t SW1_IRQ;
    MCU_IRQ_t reserved6[7U];
    MCU_IRQ_t SPIA_RX_IRQ;
    MCU_IRQ_t SPIA_TX_IRQ;
    MCU_IRQ_t reserved7[6U];
    MCU_IRQ_t SW2_IRQ;
    MCU_IRQ_t reserved8[7U];
    MCU_IRQ_t I2C1A_IRQ;
    MCU_IRQ_t I2C2A_IRQ;
    MCU_IRQ_t reserved9[6U];
    MCU_IRQ_t SCIA_RX_IRQ;
    MCU_IRQ_t SCIA_TX_IRQ;
    MCU_IRQ_t reserved10[6U];
    MCU_IRQ_t ADC1_IRQ;
    MCU_IRQ_t ADC2_IRQ;
    MCU_IRQ_t ADC3_IRQ;
    MCU_IRQ_t ADC4_IRQ;
    ...
    MCU_IRQ_t ADC8_IRQ;
    MCU_IRQ_t SW3_IRQ;
    MCU_IRQ_t reserved11[7U];
    MCU_IRQ_t X3_IRQ;
    MCU_IRQ_t reserved12[7U];
}PIE_IRQ_EXT_t;
