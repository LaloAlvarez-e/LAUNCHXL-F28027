...
typedef enum
{
    ...
    PIE_enVECTOR_IRQ_XINT1         = (MCU_enINT_VECTOR_USER12 + 1U) + (((MCU_enINT_VECTOR_GROUP1 - 1U) << 3U) | 3U),
    PIE_enVECTOR_IRQ_XINT2         = (MCU_enINT_VECTOR_USER12 + 1U) + (((MCU_enINT_VECTOR_GROUP1 - 1U) << 3U) | 4U),
    ...
    PIE_enVECTOR_IRQ_XINT3         = (MCU_enINT_VECTOR_USER12 + 1U) + (((MCU_enINT_VECTOR_GROUP12 - 1U) << 3U) | 0U),
